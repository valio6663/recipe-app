...
export const uploadRecipe = async function(newRecipe) {
    try {
        ...
        const ingredients = newRecipe.ingredients || Object.entries(newRecipe)
      .filter(entry => entry[0].startsWith('ingredient') && entry[1] !== '')
      .map(ing => {
        if (typeof ing[1] !== 'string') {
          throw new Error(`Invalid ingredient format: ${ing[1]}`);
        }
    ...
    console.log('Processed Ingredients:', ingredients);
        ...
        console.log('Recipe to upload:', recipe);
